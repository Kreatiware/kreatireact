 ...
 * @author ai — Pending designer review
 */
export const StarHalf: React.FC<IconProps> = ({
  size = 24,
  color = "currentColor",
  className = "",
}) => (
 ...
 * @author ai — Pending designer review
 */
export const TimesCircle: React.FC<IconProps> = ({
  size = 24,
  color = "currentColor",
  className = "",
}) => (
 ...
 * @author ai — Pending designer review
 */
export const EllipsisV: React.FC<IconProps> = ({
  size = 24,
  color = "currentColor",
  className = "",
}) => (
 ...
 * @author ai — Pending designer review
 */
export const ListUnordered: React.FC<IconProps> = ({
  size = 24,
  color = "currentColor",
  className = "",
}) => (
 ...
 * @author ai — Pending designer review
 */
export const CodeInline: React.FC<IconProps> = ({
  size = 24,
  color = "currentColor",
  className = "",
}) => (
 ...
 * @author ai — Pending designer review
 */
export const TextColor: React.FC<IconProps> = ({
  size = 24,
  color = "currentColor",
  className = "",
}) => (
 ...
 * @author ai — Pending designer review
 */
export const BgColor: React.FC<IconProps> = ({
  size = 24,
  color = "currentColor",
  className = "",
}) => (
 ...
 * @author ai — Pending designer review
 */
export const FontFamily: React.FC<IconProps> = ({
  size = 24,
  color = "currentColor",
  className = "",
}) => (
