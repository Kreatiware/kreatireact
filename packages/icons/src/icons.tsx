...
/**
 * Bold icon — text formatting bold
 * @author ai — Pending designer review
 */
export const Bold: React.FC<IconProps> = ({ size = 24, color = 'currentColor', className = '' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill={color} className={className} aria-hidden="true">
    <path d="M15.6,11.79c.97-.73,1.6-1.86,1.6-3.14,0-2.21-1.79-4-4-4H7v14h7.04c2.09,0,3.71-1.7,3.71-3.79,0-1.52-.86-2.82-2.15-3.07ZM10,7.5h3c.83,0,1.5.67,1.5,1.5s-.67,1.5-1.5,1.5h-3v-3Zm3.5,9H10v-3h3.5c.83,0,1.5.67,1.5,1.5s-.67,1.5-1.5,1.5Z" />
  </svg>
);

/**
 * Italic icon — text formatting italic
 * @author ai — Pending designer review
 */
export const Italic: React.FC<IconProps> = ({ size = 24, color = 'currentColor', className = '' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill={color} className={className} aria-hidden="true">
    <path d="M10,4v3h2.21l-3.42,8H6v3h8v-3H11.79l3.42-8H18V4H10Z" />
  </svg>
);

/**
 * Underline icon — text formatting underline
 * @author ai — Pending designer review
 */
export const Underline: React.FC<IconProps> = ({ size = 24, color = 'currentColor', className = '' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill={color} className={className} aria-hidden="true">
    <path d="M12,17c3.31,0,6-2.69,6-6V3H15.5v8c0,1.93-1.57,3.5-3.5,3.5S8.5,12.93,8.5,11V3H6v8c0,3.31,2.69,6,6,6Zm-7,2v2H19v-2H5Z" />
  </svg>
);

/**
 * Strikethrough icon — text formatting strikethrough
 * @author ai — Pending designer review
 */
export const Strikethrough: React.FC<IconProps> = ({ size = 24, color = 'currentColor', className = '' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill={color} className={className} aria-hidden="true">
    <path d="M10,19h4v-3H10v3ZM5,4v3h5v3h4V7h5V4H5ZM3,14h18v-2H3v2Z" />
  </svg>
);

/**
 * ListUnordered icon — bullet list
 * @author ai — Pending designer review
 */
export const ListUnordered: React.FC<IconProps> = ({ size = 24, color = 'currentColor', className = '' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill={color} className={className} aria-hidden="true">
    <path d="M4,10.5c-.83,0-1.5.67-1.5,1.5s.67,1.5,1.5,1.5,1.5-.67,1.5-1.5-.67-1.5-1.5-1.5Zm0-6c-.83,0-1.5.67-1.5,1.5s.67,1.5,1.5,1.5,1.5-.67,1.5-1.5-.67-1.5-1.5-1.5Zm0,12c-.83,0-1.5.68-1.5,1.5s.68,1.5,1.5,1.5,1.5-.68,1.5-1.5-.67-1.5-1.5-1.5ZM8,19h14v-2H8v2Zm0-6h14v-2H8v2ZM8,5v2h14V5H8Z" />
  </svg>
);

/**
 * ListOrdered icon — numbered list
 * @author ai — Pending designer review
 */
export const ListOrdered: React.FC<IconProps> = ({ size = 24, color = 'currentColor', className = '' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill={color} className={className} aria-hidden="true">
 ...
 * @author ai — Pending designer review
 */
export const Link: React.FC<IconProps> = ({ size = 24, color = 'currentColor', className = '' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill={color} className={className} aria-hidden="true">
...
/**
 * CodeInline icon — code brackets
 * @author ai — Pending designer review
 */
export const CodeInline: React.FC<IconProps> = ({ size = 24, color = 'currentColor', className = '' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill={color} className={className} aria-hidden="true">
...
/**
 * Blockquote icon — quote block
 * @author ai — Pending designer review
 */
export const Blockquote: React.FC<IconProps> = ({ size = 24, color = 'currentColor', className = '' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill={color} className={className} aria-hidden="true">
    <path d="M6,17h3l2-4V7H5v6h3L6,17Zm8,0h3l2-4V7H13v6h3l-2,4Z" />
  </svg>
);

/**
 * Undo icon — undo action
 * @author ai — Pending designer review
 */
export const Undo: React.FC<IconProps> = ({ size = 24, color = 'currentColor', className = '' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill={color} className={className} aria-hidden="true">
    <path d="M12.5,8c-2.65,0-5.05,1.04-6.83,2.73L2.5,7.56v8.94h8.94l-3.18-3.18c1.33-1.33,3.17-2.15,5.24-2.15,3.03,0,5.61,1.81,6.76,4.41l2.24-.93c-1.52-3.44-4.93-5.83-8.99-5.83Z" />
  </svg>
);

/**
 * Redo icon — redo action
 * @author ai — Pending designer review
 */
export const Redo: React.FC<IconProps> = ({ size = 24, color = 'currentColor', className = '' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill={color} className={className} aria-hidden="true">
